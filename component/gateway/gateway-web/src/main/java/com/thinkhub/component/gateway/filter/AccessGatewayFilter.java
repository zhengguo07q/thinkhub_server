package com.thinkhub.component.gateway.filter;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.thinkhub.component.auth.client.service.IAuthService;
import com.thinkhub.component.gateway.service.IPermissionService;
...
public class AccessGatewayFilter implements GlobalFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (authService.ignoreAllAuthentication()|| authService.ignoreAuthentication(url)) {
