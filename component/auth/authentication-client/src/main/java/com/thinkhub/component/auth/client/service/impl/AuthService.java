package com.thinkhub.component.auth.client.service.impl;

import com.thinkhub.component.auth.client.provider.AuthProvider;
import com.thinkhub.component.auth.client.service.IAuthService;
...
public class AuthService implements IAuthService {
     ...
     * 调试
     */
    @Value("${gate.ignore.authentication.enable}")
    private boolean enableIgnore = false;
    ...
    @Override
    public boolean ignoreAllAuthentication() {
